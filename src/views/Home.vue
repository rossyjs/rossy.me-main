...
<PreLoader/>
    ...
    <div id="padding1-home" class="p-[2rem] pt-[1rem]">
      <ul id="accounts-router" class="flex gap-[15px] list-none">
        <a href="https://instagram.com/rossydiyebiri" class="account-item"> <i class="fa fa-instagram"></i> </a>
        <a href="https://github.com/rossyjs" class="account-item"> <i class="fab fa-github"></i> </a>
         <a href="https://open.spotify.com/user/qunk023vie2h65dmg54x28p38?si=e3f4ccb2633b4093" class="account-item"> <i class="fab fa-spotify"></i> </a>
          <a href="https://discord.gg/rossy" class="account-item"> <i class="fab fa-discord"></i> </a>
      </ul>
      <h1 class="mt-[50px] mb-[25px] text-white font-bold text-[45px]" style="font-family:Curly">Hello, I am <font color="#ff4a57"> Rossy. </font></h1>
...
></vue-typer></p>
<a href="https://github.com/rossyjs" class="w-[171px] font-medium h-[55px] pt-[13px] text-[15px] pb-[13px] pl-[40px] pr-[40px] rounded-[50px] border-[#ff4a57] border-2 hover:bg-[#ff4a57] text-white" style="transition: .3s ease;">View on Github</a>
    </div>
...
export default { 
  ...
  mounted(){
    ...
    document.title = "Rossy"
  },
  data(){
    return { 
      presence:{},
      avatarURL:"",
      id:"837446753119764481",
      username:"",
      tag:"",
      status:"",
      discord_status:"",
      bio:["My name is Rossy Im Discord Developers"],
      spotify:{},
